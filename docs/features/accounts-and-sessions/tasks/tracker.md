...
|---|---|---|---|---|---|---|
| T1 | Identity account model + identity-schema migration | migration | Alex Korneiko | M | — | todo |
| T2 | Session entity owning the 14-day and 90-day rules | domain | Alex Korneiko | S | — | todo |
